...
func InitMiniboard(b *board_t) {
	fmt.Printf("plat: Initializing miniboard\n")
	miniboard = true
	b.phy_pin_count = 56
	b.aio_count = 0
	...
	b.pins[pos].capabilities = pin_capabilities_t{true, true, true, false, false, false, false, false}
	...
	b.pins[pos].capabilities = pin_capabilities_t{true, false, false, false, false, false, false, false}
	pos++
	...
	b.pins[pos].capabilities = pin_capabilities_t{true, true, false, false, false, false, false, false}
	...
	b.pins[pos].capabilities = pin_capabilities_t{true, true, false, false, false, true, false, false}
	...
	b.pins[pos].capabilities = pin_capabilities_t{true, true, false, false, true, false, false, false}
	...
	b.pins[pos].capabilities = pin_capabilities_t{true, true, false, false, false, false, false, true}
...
func InitEdison() error {
	fmt.Printf("plat: Initializing Edison\n")
	board := board_t{}
	_, err := GpioInitRaw(214)
	if err != nil {
		InitMiniboard(&board)
	} else {
		//InitArduino
